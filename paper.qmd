...
# Price's index - recency of references ------------------
library(stringr)
...
#| fig-cap: Distribution of article characteristics for archaeology articles over time. Individual articles are shown by data points. The Ordinary Least Squares method was used to fit the straight lines summarising the relationships between the variables and the time series.     
