...
In 2024 the *Journal of Archaeological Science* introduced a new kind of peer review that has provided an opportunity to investigate computational reproducibility in archaeology. In January 2024 I accepted the position of 'Associate Editor for Reproducibility' and conducted peer reviews of submissions that mentioned programming languages such as R or Python in the methods sections.
