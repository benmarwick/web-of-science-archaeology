...
At the time of writing (Feburary 2025) I have completed 47 reproducibility reviews of 25 manuscripts submitted to JAS. Of these, 11 have been published in JAS so far. Seven of these eleven papers fully passed the reproducibility review, resulting in a success rate so of 63%. Four of the seven papers could be fully reproduced on my first attempt, the others required additional input from the authors.

it is hard to assess whether reported findings are credible.
