...
source(here::here("analysis/code/008-redraw-Fanelli-and-Glanzel-Fig-2.R"))
...
over_time_long_colour %>% 
  nest(.by = variable) %>% 
  mutate(fit = map(data, ~mgcv::gam(value ~ s(year, bs = "cs"), data = .)),
